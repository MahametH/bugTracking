...
public class ProjectResourceIT {
    ...
    @Test
    @Transactional
    public void getAllProjectsByMembersIsEqualToSomething() throws Exception {
        // Initialize the database
        projectRepository.saveAndFlush(project);
        ...
        // Get all the projectList where members equals to membersId + 1
        defaultProjectShouldNotBeFound("membersId.equals=" + (membersId + 1));
    }


    @Test
    @Transactional
    public void getAllProjectsByBugsIsEqualToSomething() throws Exception {
        // Initialize the database
        projectRepository.saveAndFlush(project);
        Bug bugs = BugResourceIT.createEntity(em);
        em.persist(bugs);
        em.flush();
        project.addBugs(bugs);
        projectRepository.saveAndFlush(project);
        Long bugsId = bugs.getId();

        // Get all the projectList where bugs equals to bugsId
        defaultProjectShouldBeFound("bugsId.equals=" + bugsId);

        // Get all the projectList where bugs equals to bugsId + 1
        defaultProjectShouldNotBeFound("bugsId.equals=" + (bugsId + 1));
    }
